...
exports.followRoutes = (0, express_1.Router)();
exports.followRoutes.use(middleware_1.default);
const prisma = new client_1.PrismaClient();
exports.followRoutes.post("/follow", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.followRoutes.post("/unfollow", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const userId = req.userId;
    const { toUserId } = req.body;
    try {
        const user = yield prisma.user.findUnique({
